...
| schema prune + mini | $0.00352 | 63.3% | 0.83x |
| schema prune + nano | $0.00084 | 65.0% | **0.20x** |
| schema prune + strong | $0.01065 | 86.7% | 2.5x (cost up) |
...
strongest tier reaches **86.7% quality (52/60, above the 85.3% floor)** but at
2.5x the cost, so we do not ship it flat; the open question is whether a
strong-tier *verification* pass on a cheap base can buy that same quality at a
fraction of the strong-tier cost.
...
**Decision needed from you:** we can hold quality at ~65% at **$0.00084 per
resolved case** (ship today, 20% of prior spend), or spend up to a further
~2-3x of that budget on verification/strong-tier retries to clear the 85%
quality bar that the flat strong tier already meets but at 2.5x cost. I
recommend approving the verification workstream — at ~2x of the nano point it
would still be under 40% of prior cost. Do you approve the added verification
spend?
